...
const SearchBox = ({ open, type, text }) => {
  ...
  return (
    <div
      className={`${
        type === "navbar"
          ? "w-full h-screen md:w-full md:h-auto md:absolute md:left-0 md:min-w-[260px] md:max-w-[300px] md:max-w-[450px] fixed top-16 left-0 z-50"
          ...
          >
            ...
            >
              <div className="w-4/12 h-full">
                <Image
                  src={`${ele?.attributes?.image?.data?.attributes?.formats?.thumbnail?.url}`}
                  alt="house"
                  width={0}
                  height={0}
                  sizes={"100vw"}
